...
if($act = 'get_goods')
{
	...
	if (!$smarty->is_cached($template, $cache_id))
	{
		...
		$sql = "SELECT b.brand_id, b.brand_name, b.brand_logo, COUNT(*) AS goods_num ".
				...
				"GROUP BY b.brand_id HAVING goods_num > 0 ORDER BY b.sort_order, b.brand_id ASC"; //此SQL语句增加字段 b.brand_logo,  By  www.xiaobinqipei.com
		...
		$brand_have_logo = 0;  //代码增加   By    www.xiaobinqipei.com
