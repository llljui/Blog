 ...
 * ============================================================================
 * $Author: Shadow & 小滨汽配
 * $Id: shop_config.php 17217 2016-01-19 06:29:08Z Shadow & 小滨汽配
 */
...
$_LANG['cfg_desc']['sms_sign'] = '提示：此处填写内容必须是阿里大鱼审核通过的签名，否则短信无法发送。如需技术支持请联系：小滨汽配科技 & Shadow QQ：1527200768';
...
/*fulltext_search_add_START_www.xiaobinqipei.com*/
$_LANG['cfg_name']['fulltext_search'] = '全文搜索引擎';
$_LANG['cfg_range']['fulltext_search']['0'] = '关闭';
$_LANG['cfg_range']['fulltext_search']['1'] = '开启';
/*fulltext_search_add_END_www.xiaobinqipei.com*/

/* 代码增加_注册红包start  By  www.xiaobinqipei.com */
...
/* 代码增加_注册红包end  By  www.xiaobinqipei.com */
