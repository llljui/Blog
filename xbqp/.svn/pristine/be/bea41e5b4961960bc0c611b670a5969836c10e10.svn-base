 ...
 * ============================================================================
 * $Author: Shadow & 小滨汽配
 * $Id: cycle_image.php 17217 2016-01-19 06:29:08Z Shadow & 小滨汽配
*/
...
{
    echo '<?xml version="1.0" encoding="' . EC_CHARSET . '"?><bcaster><item item_url="images/200609/05.jpg" link="www.xiaobinqipei.com" /></bcaster>';
}
?>