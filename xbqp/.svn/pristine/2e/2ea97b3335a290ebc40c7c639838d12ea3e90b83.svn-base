...
(function($){
	...
	$.ajaxSystemCategorySelecter = function(catNameObj, catIdObj, selectedId, lang_cat_expand_all, lang_cat_collect_all, lang_cat_expand, lang_cat_collect){
        console.log(9999);
		var url = "goods.php?act=ajax_system_category";
		$.get(url, {}, function(data){
			data = $.parseJSON(data);
			$.showCategorySelecter(catNameObj, catIdObj, data, selectedId);
		}, "text");
