...
$modules['02_cat_and_goods']['05_car_system_category_list'] = 'car_system_category.php?act=list';
...
$modules['09_dept']['03_dept_list'] = 'dept.php?act=list';
$modules['09_dept']['04_add_dept'] = 'dept.php?act=add';
