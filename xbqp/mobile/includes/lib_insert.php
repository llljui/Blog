...
*/
function get_car_system_children_tree($cat_id)
{
     if ($cat_id >0 )
    {
        $sql = 'SELECT count(*) FROM ' . $GLOBALS['ecs']->table('car_system_category') . " WHERE parent_id = '$cat_id'";
        ...
        if ($GLOBALS['db']->getOne($sql))
        {
            ...
            $sql = 'SELECT a.cat_id, a.cat_name, a.sort_order AS parent_order, a.cat_id, ' .
                ...
                'LEFT JOIN ' . $GLOBALS['ecs']->table('car_system_category') . ' AS b ON b.parent_id = a.cat_id ' .
        ...
        else
        {
            ...
            else
            {
                ...
                $sql = 'SELECT a.cat_id, a.cat_name FROM '
                        . $GLOBALS['ecs']->table('car_system_category') . ' AS a ' .
