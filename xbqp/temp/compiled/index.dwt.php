...
<head>
<base href="http://localhost/xbqp/" />
<meta name="Generator" content="XIAOBIN v7_2" />
...
<meta name="description" value="This example shows how to make a beautiful carousel with carouFredSel and UI Kit from Design Deck. Provided by favbulous.com" />
<meta name="keywords" value="design, carousel, uikit, ui, favbulous" />
...
<link rel="stylesheet" type="text/css" href="themes/68ecshopcom_360buy/js/xj/css/xj_1.css">
<link rel="stylesheet" type="text/css" href="themes/68ecshopcom_360buy/css/68ecshop_commin.css" />
<link rel="stylesheet" type="text/css" href="themes/68ecshopcom_360buy/js/xj/css/xj.css"> 
<!-- <link rel="stylesheet" type="text/css" href="themes/68ecshopcom_360buy/js/xj/bootstrap/dist/css/bootstrap.min.css"> 

<script type="text/javascript" src="themes/68ecshopcom_360buy/js/xj/jquery/dist/jquery.min.js"></script>
<!-- <script type="text/javascript" src="themes/68ecshopcom_360buy/js/jquery-1.6.2.min.js"></script> -->
<link rel="stylesheet" type="text/css" href="themes/68ecshopcom_360buy/js/xj/solider/solider.css">


<style type="text/css">.full-screen-slides-pagination{top: 493px;}</style>
...
$(function(){
	...
	if(screen.width=='1366'){console.log('1366px');$("#shiyin").css("left","1070px");$("#navright").css("left","1070px");}
	if(screen.width=='1440'){console.log('1440px');$("#shiyin").css("left","1107px");$("#navright").css("left","1107px");}
	if(screen.width=='1920'){console.log('1920px');$("#shiyin").css("left","1279px");$("#navright").css("left","1279px");}
...
<body >
	<div id="site-nav" style="width:100%;">
		<?php echo $this->fetch('library/page_headerindex.lbi'); ?>
		<?php echo $this->fetch('library/page_headerindex_right.lbi'); ?>

	</div>
        
		<div class="home-focus-layout">
			<!--  <img src="themes/68ecshopcom_360buy/images/xjimg/pre.png" width="20px;" height="50px;" id="xj_pre" >
			     		 <img src="themes/68ecshopcom_360buy/images/xjimg/next.png" width="20px;" height="50px;" id="xj_next"> -->
     		<script type="text/javascript" src="themes/68ecshopcom_360buy/js/xj/xj_js.js"></script>
...
<?php $this->assign('articles',$this->_var['articles_19']); ?><?php $this->assign('articles_cat',$this->_var['articles_cat_19']); ?><?php echo $this->fetch('library/cat_articles.lbi'); ?>
		...
		<?php $_from = $this->_var['row']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'row_0_02848300_1490613710');if (count($_from)):
    foreach ($_from AS $this->_var['row_0_02848300_1490613710']):
?>
		<?php if ($this->_var['row_0_02848300_1490613710']['send_start_date'] < $this->_var['time'] && $this->_var['row_0_02848300_1490613710']['send_end_date'] > $this->_var['time']): ?>
