<?php $_from = get_categories_tree(0,1); if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'cat');$this->_foreach['cat0'] = array('total' => count($_from), 'iteration' => 0);
...
<div class="list" onmouseover="_show_(this,{'source':'JS_side_cat_textarea_<?php echo $this->_foreach['cat0']['iteration']; ?>','target':'JS_side_cat_list_<?php echo $this->_foreach['cat0']['iteration']; ?>'});" onmouseout="_hide_(this);" >
	<dl class="cat" <?php if (($this->_foreach['cat0']['iteration'] == $this->_foreach['cat0']['total']) || $this->_foreach['cat0']['iteration'] == 9): ?>style="border:none"<?php endif; ?>>
  		<dt class="catName"> 
...
?>
	...
	<div id="JS_side_cat_list_<?php echo $this->_foreach['cat0']['iteration']; ?>" class="hideMap Map_positon<?php echo $this->_foreach['cat0']['iteration']; ?>" style="width:570px;"></div>
</div>
<?php endif; ?> 
<?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?> 
