      ...
      <div class="header-extra">
        ...
        <div id="search_tips" style="display:none;"></div>
          <ul class="search-type clearfix">
          	<li <?php if ($_REQUEST['type'] == 0): ?>class="cur"<?php endif; ?> num="0">配件</li>
              ...
              <div class="mallSearch-input clearfix">
                <div id="s-combobox-135" class="s-combobox">
                  <div class="s-combobox-input-wrap">
                    <input aria-haspopup="true" role="combobox" class="s-combobox-input" name="keywords" id="keyword" tabindex="9" accesskey="s" onkeyup="STip(this.value, event);" autocomplete="off"  value="<?php if ($this->_var['search_keywords']): ?><?php echo htmlspecialchars($this->_var['search_keywords']); ?><?php else: ?>请输入汽车零配件的关键词<?php endif; ?>" onFocus="if(this.value=='请输入汽车零配件的关键词'){this.value='';}else{this.value=this.value;}" onBlur="if(this.value=='')this.value='请输入汽车零配件的关键词'" type="text">
                  </div>
                </div>
...
<div class="globa-nav">
  <div class="w">
  	<div class="allGoodsCat Left" > 
    	<a href="catalog.php" class="menuEvent" title="按品牌车型车系导航"><strong class="catName">按品牌车型车系导航</strong><i></i></a>
   </div>
   <?php echo $this->fetch('library/head_nav.lbi'); ?>

  </div>
          <div class="allGoodsCat Left" id="navright" style="width:100%;position:absolute;z-index:105;"> 
                <a href="car_system_catalog.php" class="menuEvent" title="按汽车零配件导航"><strong class="catName">按汽车零配件导航</strong><i></i></a>
           </div>
</div>
