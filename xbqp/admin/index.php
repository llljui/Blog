...
elseif ($_REQUEST['act'] == 'top')
{
    ...
    // 代码修改   By  www.xiaobinqipei.com Start
    // 获得管理员设置的菜单
...
//     $datainfo['comment']     = $db->GetOne('SELECT COUNT(comment_id) FROM ' . $ecs->table('comment'));
    ...
    // 代码修改   By  www.xiaobinqipei.com End
    // 获得管理员ID
...
{
    clear_all_files();
    clearhtml_all();  //代码增加   By  www.xiaobinqipei.com
    sys_msg($_LANG['caches_cleared']);
}
//www.xiaobinqipei.com手机缓存修改start
...
elseif ($_REQUEST['act'] == 'main')
{
    ...
    /*后台管理起始页_修改_START_www.xiaobinqipei.com*/
...
//    " WHERE supplier_id=0 " . order_query_sql('finished');
    ...
    /*后台管理起始页_修改_END_www.xiaobinqipei.com*/
